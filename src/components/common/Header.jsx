    ...
    >
      <div className="header-container">
            ...
            {navigationData.map((item) => {
              ...
              return (
                <li 
                  ...
                  onMouseEnter={() => !hasSub ? null : handleMouseEnter(item.id)}
                  onMouseLeave={() => !hasSub ? null : handleMouseLeave(item.id)}
                >
                  {hasSub ? (
                    <>
                      <button
                        ref={(el) => (dropdownRefs.current[`trigger-${item.id}`] = el)}
                          ...
                          <div className={`mega-menu-grid ${item.id === 'portfolio' ? 'portfolio-grid' : 'collaboration-grid'}`}>
                            ...
                            <div className="mega-promo-card">
                              ...
                              <div className="promo-card-content">
                                ...
                                <h4>Let's Build Something Great <span className="highlight-text">Together</span></h4>
                                <p>Partner with Tanvox Technologies and unlock new opportunities for your business.</p>
                                <a href="#partner" className="promo-cta-btn" onClick={() => setActiveDropdown(null)}>
                                  Partner With Us
                                  <svg className="btn-arrow" viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2.5">
        ...
        <div className="cta-section">
          <a href="#contact" className="cta-button" onClick={() => setActiveTab('contact')}>
            Contact Us
            <div className="cta-arrow-circle">
              <svg viewBox="0 0 16 16" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2.5" className="btn-arrow">
                <path d="M2 8H14M14 8L9 3M14 8L9 13"/>
              </svg>
            </div>
          </a>
                  ...
                  {hasSub ? (
                    <>
                      <button
                        ...
                        aria-expanded={expandedMobileAccordions[item.id] ? 'true' : 'false'}
                      >
                        {item.label}
                      ...
                      {/* Accordion Lists */}
                      <div className={`mobile-accordion-content ${expandedMobileAccordions[item.id] ? 'is-expanded' : ''}`}>
                        {isMega && (
                          <>
                            {portfolioItems.map((sub) => (
                              ...
                              >
                                <div className="mobile-dropdown-title">{sub.title}</div>
                              </a>
                            ))}
