  ...
  return (
    <div className="saas-bg-canvas no-padding-top">
      ...
      >
          ...
          <div className="projects-hero-grid">
            ...
            <div className="projects-hero-text-side">
              <div className="projects-hero-content spacing-large">
                ...
                >
                  <button className="saas-btn-primary hero-btn-gradient" onClick={scrollToCases}>
        ...
        {/* Scroll indicator */}
        <div className="hero-scroll-indicator" onClick={scrollToCases}>
          <div className="mouse-scroll-wheel">
            <div className="mouse-wheel-dot"></div>
          </div>
          <span className="scroll-indicator-text">Explore Case Studies ↓</span>
        </div>
      </section>
