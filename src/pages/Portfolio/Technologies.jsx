  ...
  return (
    <div className="saas-bg-canvas no-padding-top" ref={approachRef}>
      ...
      >
          ...
          <div className="projects-hero-grid">
            ...
            <div className="projects-hero-text-side">
              <div className="projects-hero-content spacing-large">
                ...
                >
                  <button className="saas-btn-primary hero-btn-gradient" onClick={scrollToStack}>
                    Explore Stack
        ...
        {/* Scroll indicator */}
        <div className="hero-scroll-indicator" onClick={scrollToStack}>
          <div className="mouse-scroll-wheel">
            <div className="mouse-wheel-dot"></div>
          </div>
          <span className="scroll-indicator-text">Explore Stack ↓</span>
        </div>
      </section>
